...
function setupProductAutocomplete(productId) {
    ...
    const suggestionsContainer = document.getElementById(`productNameSuggestions${productId}`);
...
document.getElementById('productQty1').addEventListener('change', updateTotalPrice);
